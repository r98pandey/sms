...
@Component({
  selector: 'app-assign-main-task-sub-task-list',
  templateUrl: './assign-main-task-sub-task-list.component.html',
  styleUrl: './assign-main-task-sub-task-list.component.scss'
})
export class AssignMainTaskSubTaskListComponent implements OnInit ,OnChanges {
  ...
  GetV2_MX_ProjectTaskSubTaskUnionList_ServerPaging() {
    let url = 'api/ProjectManagementMobile/GetV2_MX_ProjectTaskSubTaskUnionList_ServerPaging'
    this.payload.SearchStatusId = this.CurrentStatusId
 ...
 */
  ...
  resetSerachVariable() {
    ...
    this.payload = {
      ...
      SearchClientId: null,
      SearchProjectId: null,
      SearchStatusId: this.CurrentStatusId
    };
