...
import { SubTask, SubTaskCount, TaskDetail } from '../../task-management/task-interface';



@Component({
  selector: 'app-project-schedule-view-sub-task-single',
  templateUrl: './project-schedule-view-sub-task-single.component.html',
  styleUrl: './project-schedule-view-sub-task-single.component.scss'
})
export class ProjectScheduleViewSubTaskSingleComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @Input() currentsubTaskactiveId: number
  ...
  ngOnInit(): void {
    ...
    this.apiCall()
    this.subTaskactiveId = this.currentsubTaskactiveId ? this.currentsubTaskactiveId : 1;
  }
  apiCall() {
