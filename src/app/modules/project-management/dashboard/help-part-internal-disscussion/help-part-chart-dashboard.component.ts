...
@Component({
  selector: "app-help-part-chart-dashboard",
  templateUrl: "./help-part-chart-dashboard.component.html",
  styleUrls: ["./help-part-chart-dashboard.component.scss"],
})
export class HelpPartChartDashboardComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("objectSerachForGlobalChat")) {
  ...
  getObjectAfterRefresh() {
    let objectSerachForGlobalChat: any = JSON.parse(
      localStorage.getItem("objectSerachForGlobalChat")
    );
    ...
    if (objectSerachForGlobalChat.displayStart) {
      this.payload.displayStart = objectSerachForGlobalChat.displayStart;
      this.page = objectSerachForGlobalChat.page;
    }
    this.loadData();
  }  /**
  ...
  */
  setObjectBeforeRefesh() {
    let objectSerachForGlobalChat: any = {};
    console.log("this.page",this.page)
    if (this.page) {
      objectSerachForGlobalChat.displayStart = this.pageSize * (this.page - 1);
      objectSerachForGlobalChat.page = this.page;
    }
    localStorage.setItem(
      "objectSerachForGlobalChat",
      JSON.stringify(objectSerachForGlobalChat)
    );
  }
