...
@Component({
  ...
  styleUrl: './add-warranty.component.scss'
})
export class AddWarrantyComponent implements OnInit, OnChanges {
  ...
  addMaintenanceAgreementSucessModal() {
    ...
    //   url = 'api/ProjectManagement/CreateV2_MX_MaintenanceAgreement_MaintenanceModule'; //changs required
    // } else {
    url = 'api/ProjectManagement/CreateV2_MX_ProjectWarrenty';
