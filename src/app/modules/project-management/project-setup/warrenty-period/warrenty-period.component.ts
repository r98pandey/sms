...
@Component({
  selector: 'app-warrenty-period',
  templateUrl: './warrenty-period.component.html',
  styleUrl: './warrenty-period.component.scss'
})
export class WarrentyPeriodComponent implements OnInit, OnChanges {
