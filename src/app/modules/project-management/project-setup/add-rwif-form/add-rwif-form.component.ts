...
@Component({
  selector: 'app-add-rwif-form',
  templateUrl: './add-rwif-form.component.html',
  styleUrl: './add-rwif-form.component.scss'
})
export class AddRwifFormComponent implements OnInit, OnChanges {
  @Input() dDetail: any;
