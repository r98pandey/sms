...
@Component({
  selector: 'app-add-upload-mainateaance-attachment',
  templateUrl: './add-upload-mainateaance-attachment.component.html',
  styleUrl: './add-upload-mainateaance-attachment.component.scss'
})
export class AddUploadMainateaanceAttachmentComponent implements OnInit, OnChanges {
  ...
  submitprocessFromDetails(): void {
    ...
    formdata.append("MaintenanceId", this.maintenanceId);
    formdata.append("ProjectId", this.projectId);
    formdata.append("Type", 'Document');
    formdata.append("file", this.files[0], this.files[0].name);

    let url = 'api/ProjectManagement/CreateV2_MaintenanceAgreementDocument'
