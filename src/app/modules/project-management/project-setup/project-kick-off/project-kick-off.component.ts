...
import { SuccessModalComponent } from 'src/app/shared/components/success-modal/success-modal.component';
  ...
  @Component({
    selector: 'app-project-kick-off',
    templateUrl: './project-kick-off.component.html',
    styleUrl: './project-kick-off.component.scss'
  })
  export class ProjectKickOffComponent implements OnInit, OnChanges {
