...
import { ProjectSchedule, SubTask, SubTaskCount, TaskDetail } from '../work-progress-task-interface';
...
@Component({
  selector: 'app-project-work-progress-view-with-sub-task',
  templateUrl: './project-work-progress-view-with-sub-task.component.html',
  styleUrl: './project-work-progress-view-with-sub-task.component.scss'
})
export class ProjectWorkProgressViewWithSubTaskComponent implements OnInit, OnChanges, OnDestroy {
