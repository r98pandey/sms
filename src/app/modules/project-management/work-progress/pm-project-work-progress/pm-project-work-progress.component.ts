...
@Component({
  selector: 'app-pm-project-work-progress',
  templateUrl: './pm-project-work-progress.component.html',
  styleUrl: './pm-project-work-progress.component.scss'
})
export class PmProjectWorkProgressComponent  implements OnInit, AfterViewInit,OnChanges {
