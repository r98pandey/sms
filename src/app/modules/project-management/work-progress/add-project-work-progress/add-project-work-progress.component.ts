...
@Component({
  selector: 'app-add-project-work-progress',
  templateUrl: './add-project-work-progress.component.html',
  styleUrl: './add-project-work-progress.component.scss'
})
export class AddProjectWorkProgressComponent {
  ...
  getDropdownCompanyList() {
    this.dropdownServices.Getv3_MaintenanceCompanyDropDownList_Active_ProjectManagement_WorkPrograme({}).subscribe((res: any) => {
  ...
  getDropdownClientlist() {
    ...
    this.dropdownServices
      .Getv3_MaintenanceClientDropDownList_Active_ProjectManagement_WorkPrograme(payload)
      .subscribe((res: any) => {
  ...
  getDropdownDepartmentList() {
    ...
    this.dropdownServices
      .Getv3_MaintenanceDepartmentDropDownList_Active_ProjectManagement_WorkPrograme(payload)
      .subscribe((res: any) => {
  ...
  addWorkFroce() {
    ...
    modalRef.componentInstance.title = "Are you Sure to add Work Programme";
  ...
  addProjectSucessModal() {
    ...
    let url = 'api/ProjectManagement/CreateV2_MX_ProjectSchedule_WorkPrograme';
    this.CommonHttpServiceCallerService.postWithJsonDataMethod(url, requestData)
      .subscribe((res: any) => {
        this.success(res);
