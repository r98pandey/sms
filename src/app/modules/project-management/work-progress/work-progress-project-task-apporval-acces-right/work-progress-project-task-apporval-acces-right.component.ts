...
@Component({
  selector: 'app-work-progress-project-task-apporval-acces-right',
  templateUrl: './work-progress-project-task-apporval-acces-right.component.html',
  styleUrl: './work-progress-project-task-apporval-acces-right.component.scss'
})
export class WorkProgressProjectTaskApporvalAccesRightComponent  implements OnInit {
