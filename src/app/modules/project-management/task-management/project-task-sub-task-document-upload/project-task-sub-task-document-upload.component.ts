...
@Component({
  selector: 'app-project-task-sub-task-document-upload',
  templateUrl: './project-task-sub-task-document-upload.component.html',
  styleUrl: './project-task-sub-task-document-upload.component.scss'
})
export class ProjectTaskSubTaskDocumentUploadComponent implements OnInit {
  ...
  shownTheUploadButton() {
    if (this.typeView == 'task') {
      return this.currentUserRole == 'System Administrator' || this.currentUserRole == 'Super Admin' || this.createdBy?.createdById == this.currentUserId || this.startTaskAccessRight

    } else {
      return this.currentUserRole == 'System Administrator' || this.currentUserRole == 'Super Admin' || this.createdBy?.createdById == this.currentUserId || this.projectOwnerId == this.currentUserId|| this.startTaskAccessRight
