...
import { SubTaskCount, TaskDetail } from '../task-interface';
...
import { AddAccessRightComponent } from '../../project-setup/add-access-right/add-access-right.component';
...
@Component({
  ...
  styleUrl: './project-task-details.component.scss'
})
export class ProjectTaskDetailsComponent implements OnInit, AfterViewChecked, OnDestroy {
