...
@Component({
  selector: "app-eol-spare-list",
  templateUrl: "./eol-spare-list.component.html",
  styleUrls: ["./eol-spare-list.component.scss"],
})
export class EolSpareListComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem("objectSerachForEOLSpare")) {
  ...
  resetSerachVariable() {
    ...
    this.page = 1;
    localStorage.removeItem("objectSerachForEOLSpare");
    this.loadData();
  }
  /**
  ...
  setObjectBeforeRefesh() {
    let objectSerachForEOLSpare: any = {};
    if (this.selectedDropDownCompanyIdValue)
      objectSerachForEOLSpare.SearchCompanyId =
        this.selectedDropDownCompanyIdValue;
    if (this.selectedDropDownCategoryIdValue)
      objectSerachForEOLSpare.SearchCatergoryId =
        this.selectedDropDownCategoryIdValue;
    if (this.selectedDropDownSubCategoryIdValue)
      objectSerachForEOLSpare.SearchSubCategoryId =
        this.selectedDropDownSubCategoryIdValue;
    if (this.typeSpareNameValue)
      objectSerachForEOLSpare.SearchSparePartName = this.typeSpareNameValue;
    if (this.selectedDropDownSpareStatusIdValue)
      objectSerachForEOLSpare.SearchSparePartStatusId =
        this.selectedDropDownSpareStatusIdValue;
    if (this.arrayListDropDownCategoryList) {
      objectSerachForEOLSpare.arrayListDropDownCategoryList =
        this.arrayListDropDownCategoryList;
    }
    if (this.arrayListDropDownSubCategoryList) {
      objectSerachForEOLSpare.arrayListDropDownSubCategoryList =
        this.arrayListDropDownSubCategoryList;
    }
    if (this.page) {
      objectSerachForEOLSpare.displayStart = this.pageSize * (this.page - 1);
      objectSerachForEOLSpare.page = this.page;
    }
    localStorage.setItem(
      "objectSerachForEOLSpare",
      JSON.stringify(objectSerachForEOLSpare)
    );
  }
  /**
  ...
  getObjectAfterRefresh() {
    let objectSerachForEOLSpare: any = JSON.parse(
      localStorage.getItem("objectSerachForEOLSpare")
    );
    this.arrayListDropDownCategoryList =
      objectSerachForEOLSpare.arrayListDropDownCategoryList
        ? objectSerachForEOLSpare.arrayListDropDownCategoryList
    ...
    this.selectedDropDownSubCategoryIdValue =
      objectSerachForEOLSpare.SearchSubCategoryId
        ? objectSerachForEOLSpare.SearchSubCategoryId
        : null;
    this.typeSpareNameValue = objectSerachForEOLSpare.SearchSparePartName
      ? objectSerachForEOLSpare.SearchSparePartName
      : null;
    this.selectedDropDownSpareStatusIdValue =
      objectSerachForEOLSpare.SearchSparePartStatusId
        ? objectSerachForEOLSpare.SearchSparePartStatusId
    ...
    this.payload.SearchSparePartStatusId =
      this.selectedDropDownSpareStatusIdValue;
    if (objectSerachForEOLSpare.displayStart) {
      this.payload.displayStart = objectSerachForEOLSpare.displayStart;
      this.page = objectSerachForEOLSpare.page;
    }
    this.loadData();
  }
