...
export class ViewNewUserComponent implements OnInit {
  ...
  constructor(
    ...
    if (
      ...
      this.GetV3_ProjectManagement_MyTask_ByUserId(UserProfileService.selectedUserId);
      this.getV2_TechnitionsAttendanceTransactionDaily_ByStaff(UserProfileService.selectedUserId);
    }
  }
  ngOnInit(): void {
    ...
    if (this.router.url.includes('employee-profile-view')) {
      this.label = "Employee Profile View";
      this.breadCrumbItems = [
        { label: "Human Resource" },
        { label: "Employee Profile View", active: true },
      ];
    } else {
      this.label = "Staff";
      this.breadCrumbItems = [
