...
@Component({
  selector: "app-view-print-schedule",
  templateUrl: "./view-print-schedule.component.html",
  styleUrls: ["./view-print-schedule.component.scss"],
})
export class ViewPrintScheduleComponent implements OnInit, OnChanges {
