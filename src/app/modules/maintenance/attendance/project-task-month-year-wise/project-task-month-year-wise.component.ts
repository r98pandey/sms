...
@Component({
  selector: 'app-project-task-month-year-wise',
  templateUrl: './project-task-month-year-wise.component.html',
  styleUrl: './project-task-month-year-wise.component.scss'
})
export class ProjectTaskMonthYearWiseComponent implements OnInit, OnChanges {
  ...
  Get_V3_GetTotalWorkingHours12Month_ProjectTask() {
    let url = 'api/MaintentDash/Get_V3_GetTotalWorkingHours12Month_ProjectTask'
  ...
  ngOnInit(): void {
    this.currentIndex = sessionStorage.getItem("ProjectTaskCurrentIndexWorkingHoursTop") ? Number(sessionStorage.getItem("ProjectTaskCurrentIndexWorkingHoursTop")) : 0;
  ...
  Get_V3_GetTotalWorkingHoursDetailList_ProjectTask(yearMonth) {
    ...
    let url = 'api/MaintentDash/Get_V3_GetTotalWorkingHoursDetailList_ProjectTask'
  ...
  Get_V3_GetTotalWorkingHoursByTech_ProjectTask(yearMonth) {
    ...
    let url = 'api/MaintentDash/Get_V3_GetTotalWorkingHoursByTech_ProjectTask'
    this.commonHttpServiceCallerService.postWithJsonDataMethod(url, paylod).subscribe((res: any) => {
