...
@Component({
  selector: "app-asset-rma-list",
  templateUrl: "./asset-rma-list.component.html",
  styleUrls: ["./asset-rma-list.component.scss"],
})
export class AssetRMAListComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  loadData() {
    this.assetService
      .GetV2_CommanAssetListRMA_ByPagination(
  ...
  viewHandler(assetId: any) {
    ...
    this.assetService.backTabs = "RMA Asset";
