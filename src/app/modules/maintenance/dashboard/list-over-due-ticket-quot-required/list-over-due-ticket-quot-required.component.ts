...
@Component({
  selector: "app-list-over-due-ticket-quot-required",
  templateUrl: "./list-over-due-ticket-quot-required.component.html",
  styleUrls: ["./list-over-due-ticket-quot-required.component.scss"],
})
export class ListOverDueTicketQuotRequiredComponent implements OnChanges {
  @Input() listOverDueTicketQuotRequired: any[];
  ...
  viewHandler(ticketId: any) {
    ...
    this.ticketService.ticketPageAction =
      "List Over Due New Ticket Quotation Required Page";
