...
@Component({
  selector: "app-list-over-due-new-ticket",
  templateUrl: "./list-over-due-new-ticket.component.html",
  styleUrls: ["./list-over-due-new-ticket.component.scss"],
})
export class ListOverDueNewTicketComponent implements OnChanges {
  @Input() listOverDueNewTicket: any[];
