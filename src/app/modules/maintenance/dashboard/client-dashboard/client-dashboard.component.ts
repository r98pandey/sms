...
import { statData, ActiveProjects, MyTask, TeamMembers } from '../help-desk-dashboard/data';
...
export class ClientDashboardComponent {
  ...
  ngOnInit(): void {
    ...
    this._OverviewChart('["--vz-primary", "--vz-warning","--vz-danger","--vz-success"]');
    this._status7('["--vz-success", "--vz-primary", "--vz-warning", "--vz-danger"]');

    this.getMaintenanceTodoList()
  }
