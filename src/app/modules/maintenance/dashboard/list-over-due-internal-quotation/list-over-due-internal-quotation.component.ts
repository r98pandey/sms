...
@Component({
  selector: "app-list-over-due-internal-quotation",
  templateUrl: "./list-over-due-internal-quotation.component.html",
  styleUrls: ["./list-over-due-internal-quotation.component.scss"],
})
export class ListOverDueInternalQuotationComponent implements OnChanges {
  @Input() listOverDueInternalQuotation: any[];
  ...
  viewHandler(ticketId: any) {
    ...
    this.ticketService.ticketPageAction =
      "List Over Due Internal Quotation Page";
