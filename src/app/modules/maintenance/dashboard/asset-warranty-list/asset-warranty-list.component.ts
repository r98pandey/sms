...
@Component({
  selector: "app-asset-warranty-list",
  templateUrl: "./asset-warranty-list.component.html",
  styleUrls: ["./asset-warranty-list.component.scss"],
})
export class AssetWarrantyListComponent implements OnInit, AfterViewInit {
  ...
  loadData() {
    this.assetService
      .GetV2_CommanAssetListWarrenty_ByPagination(
  ...
  viewHandler(assetId: any) {
    ...
    this.assetService.backTabs = "Warranty Asset";
