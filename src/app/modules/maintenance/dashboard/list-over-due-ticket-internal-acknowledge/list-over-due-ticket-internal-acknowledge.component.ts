...
@Component({
  selector: "app-list-over-due-ticket-internal-acknowledge",
  templateUrl: "./list-over-due-ticket-internal-acknowledge.component.html",
  styleUrls: ["./list-over-due-ticket-internal-acknowledge.component.scss"],
})
export class ListOverDueTicketInternalAcknowledgeComponent
  implements OnChanges
{
  @Input() listOverDueTicketInternalAcknowledge: any[];
