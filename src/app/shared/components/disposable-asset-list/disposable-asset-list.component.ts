...
@Component({
  selector: 'app-disposable-asset-list',
  templateUrl: './disposable-asset-list.component.html',
  styleUrl: './disposable-asset-list.component.scss'
})
export class DisposableAssetListComponent implements OnInit, OnChanges, AfterViewInit{
