...
@Component({
  selector: "app-common-asset-list",
  templateUrl: "./common-asset-list.component.html",
  styleUrls: ["./common-asset-list.component.scss"],
})
export class CommonAssetListComponent
  implements OnInit, OnChanges, AfterViewInit
{
  ...
  onCheckboxChange(ev) {
    ...
    this.assetListSelected.emit(this.checkedAssetList);
  }

  checkUncheckAll() {
    return this.assetList.every((p) => p.checked);
  }
